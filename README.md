...
> データサイエンス講座の課題として始めた分析をベースに、**データ統合プロセス（作り方）**を含めて整理する方針で発展させています。
>
> **現在の実装状況**
...
<p align="center"> <img src="outputs/figures/subgroup_turnover_structure.png" width="900"> </p>
主な示唆
...
※ 本分析は探索的検証であり、因果関係を示すものではない。
※ 行政区分としての都市・地方とは一致しない統計的区分を使用している。
